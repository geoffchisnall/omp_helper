...
#test
		...
		xml = xmldoc.getElementsByTagName("xml")[0]
		tasks = xml.getElementsByTagName("task")
		print "TASKNAME", ' '*5, "COMMENT", ' '*5, "STATUS", ' '*10, "TASK ID",' '*20, "SEVERITY",' '*8, "TREND",' '*5, "MODIFICATION TIME"
		for task in tasks:
			...
			print taskname, ' '*5, taskcomment, ' '*2, taskstatus, ' '*2, taskid,' '*8, taskseverity, ' '*8, tasktrend, ' '*5, modificationtime
		os.system("rm tasks.xml")
